  ...
  return (
    <div className="pt-[11px] pb-7 px-4 bg-[#F9F9F9]">
      <div className="flex flex-row items-center justify-between">
        {props.discountproduct.new && (
          <div className="py-[2px] px-[22px] text-white bg-[#43D167] rounded-[8px]">
            New
          </div>
        )}
        {props.discountproduct.discount !== 0 && (
          <div className="py-[2px] px-[22px] text-white bg-[#DF4244] rounded-[8px]">
            {props.discountproduct.discount} %
          </div>
        )}
        {!(props.discountproduct.discount || props.discountproduct.new) && (
      ...
      <div className="w-[218px] h-[243px] mx-auto">
        <img src={props.discountproduct?.image} alt="laptopbag" />
      </div>
